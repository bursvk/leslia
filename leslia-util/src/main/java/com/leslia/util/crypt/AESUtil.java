...
public class AESUtil {
     ...
     * 6.返回字符串
     */
    public static String aesEncode(String encode_rules,String content) {
        try {
            ...
            random.setSeed(encode_rules.getBytes("utf-8"));
     ...
     * 3.将加密内容解密
     */
    public static String aesDecode(String encode_rules,String content) {
        try {
            //1.构造密钥生成器，指定为AES算法,不区分大小写
